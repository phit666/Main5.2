...
public:
	...
	virtual bool Init(const unsigned char *key, unsigned int length) = 0;
    virtual int Encrypt(const unsigned char *inBuf, unsigned int inLen, unsigned char *outBuf) = 0;
    virtual int Decrypt(const unsigned char *inBuf, unsigned int inLen, unsigned char *outBuf) = 0;
...
public:
    ...
    bool Init(const unsigned char *key, unsigned int length)
    {
    ...
    int Encrypt(const unsigned char *inBuf, unsigned int inLen, unsigned char *outBuf)
    {
        int paddingSize = 0;
    ...
    int Decrypt(const unsigned char *inBuf, unsigned int inLen, unsigned char *outBuf)
    {
...
public:
    ...
    unsigned int GetAlgorithm() { return this->m_algorithm; }
...
public:
    ...
    void updateData(Cryptor *cryptor, unsigned char *buf, int size);
