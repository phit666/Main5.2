...
public:
	...
	void Initialize(WORD wItemCode, int iPackageSeq, int iDisplaySeq, int iPriceSeq, int iCashType,unicode::t_char* pszName, unicode::t_char* pszPrice, unicode::t_char* pszPeriod);
