...
{
#ifdef __ANDROID__
	if ((MU_EditHasFocus(m_pIDInputBox->ec) || MU_EditHasFocus(m_pPassInputBox->ec)) && g_focusinputresize == 0) {
	...
	else if (!MU_EditHasFocus(m_pIDInputBox->ec) && !MU_EditHasFocus(m_pPassInputBox->ec) && g_focusinputresize != 0) {
