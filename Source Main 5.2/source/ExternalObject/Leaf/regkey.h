...
namespace leaf{
	...
	public:
#ifdef MU_USE_SDL
		enum _HKEY{ _HKEY_CLASSES_ROOT = (unsigned long)(ULONG_PTR)HKEY_CLASSES_ROOT,
			_HKEY_CURRENT_CONFIG = (unsigned long)(ULONG_PTR)HKEY_CURRENT_CONFIG,
			_HKEY_CURRENT_USER = (unsigned long)(ULONG_PTR)HKEY_CURRENT_USER,
			_HKEY_LOCAL_MACHINE = (unsigned long)(ULONG_PTR)HKEY_LOCAL_MACHINE,
			_HKEY_USERS = (unsigned long)(ULONG_PTR)HKEY_USERS
		};
#else
